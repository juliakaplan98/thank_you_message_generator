    ...
    while True:
        ...
        if choice == '1':
            ...
            if choice == '1':
                ...
                # Create group
                new_group = GroupData(
                    group_id, group_address, group_email, group_phone, group_gift)
                ...
                for i in range(0, group_size):
                    ...
                    guest_attendance = input(
                        f"Did {guest_name} attend the event (Y/N)? ")
                ...
                df = pd.DataFrame(data, columns=[
                                  'ID', 'Party Members', 'Address', 'Email', 'Phone Number', 'Attendance Status', 'Gift'])
                ...
                print(f'\nIncorrect menu option selected: {
                      choice}. Please select an option from the menu.')
        elif choice == '2':
            show_message_menu()
            choice = input("\nSelect Option from Menu: ").lower()
            if choice == '1':
